...
import com.nqvinh.noti.consumer.application.dto.MailMessageKafka;
...
public class KafkaEmailConsumer {
    ...
    @KafkaListener(
            ...
            properties = {"spring.json.value.default.type=com.nqvinh.noti.consumer.application.dto.MailMessageKafka"},
